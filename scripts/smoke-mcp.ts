...
try{
 ...
 console.log(JSON.stringify({ok:true,tool_count:tools.tools.length,session_id:session.session_id,cursor:capture.cursor,card_type:current.cards[0].type,ui_tool:tools.tools.some(t=>t.name==="open_knowledge_panel")},null,2));
