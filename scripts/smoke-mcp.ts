...
try{
 ...
 const required=["start_learning_session","rename_learning_session","capture_conversation_turn","capture_active_learning_turn","get_learning_session","export_learning_package","launch_knowledge_copilot","open_knowledge_panel"];
