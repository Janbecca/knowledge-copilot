...
try{
 ...
 const required=["start_learning_session","rename_learning_session","capture_conversation_turn","capture_active_learning_turn","get_learning_session","change_extraction_mode","export_learning_package","launch_knowledge_copilot","open_knowledge_panel"];
 ...
 const started=await client.callTool({name:"start_learning_session",arguments:{title:"MCP smoke",source_host:"sdk-smoke",extraction_mode:"server_llm"}});const session=started.structuredContent as any;
